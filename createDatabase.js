...
db.serialize(() => {
  db.run(
    'CREATE TABLE sessionsTable (sessionID INT, tweetID VARCHAR(30),date VARCHAR(30), osuUsername VARCHAR(100), sessionDuration VARCHAR(50), globalRank VARCHAR(15), difGlobalRank VARCHAR(15), countryRank VARCHAR(15), difCountryRank VARCHAR(15),' +
  ...
  db.run(
    'CREATE TABLE playsTable (sessionID INT, background VARCHAR(100), title VARCHAR(100), version VARCHAR(100), artist VARCHAR(100), combo VARCHAR(50), bpm VARCHAR(3), playDuration VARCHAR(15), difficulty VARCHAR(6),' +
